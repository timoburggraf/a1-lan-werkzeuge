...
OBJEKTE = [
    ("Gehaeuse_Korpus",   [("Gehaeuse_Korpus", 1)]),
    ("Gehaeuse_Front",    [("Gehaeuse_Front", 1), ("Front_Schrift", 2)]),
    ("PCB_Halter",        [("PCB_Halter", 1)]),
    ("Rastzunge",         [("Rastzunge", 1)]),
    ("Front_Blende",      [("Front_Blende", 1), ("Blende_Schrift", 2)]),
    ("Klemmen_Abdeckung", [("Klemmen_Abdeckung", 1), ("Klemmen_Schrift", 2)]),
    ("Zugentlastung",     [("Zugentlastung", 1)]),
    ("USB_Klappe",        [("USB_Klappe", 1)]),
    ("Lichtleiter_L",     [("Lichtleiter_L", 1)]),
    ("Lichtleiter_R",     [("Lichtleiter_R", 1)]),
]

ZIEL = "ems14a_platte.3mf"
...
def bauen():
    xml = ['<?xml version="1.0" encoding="UTF-8"?>',
           ...
           ' <metadata name="Title">ems14a Prototyp — ganze Platte, zweifarbig</metadata>',
